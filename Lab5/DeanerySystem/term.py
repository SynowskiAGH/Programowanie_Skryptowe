...
class Term:
    ...
    def __sub__(first, second):
        first_hour = first.__duration // 60
        first_minute = first.__duration % 60
        first.__hour = first.__hour + first_hour
        first.__minute = first.__minute + first_minute
        ret___hour = (first.__hour - second.hour)*60
        ret___minute = first.__minute - second.minute
        return Term(second.hour, second.minute, (ret___hour+ret___minute))
